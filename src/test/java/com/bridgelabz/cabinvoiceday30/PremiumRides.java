    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                System.out.print("Enter the ride type (Normal/Premium): ");
                ...
                System.out.println("Total fare amount for the rides: " + fare);
                System.out.println("Average fare amount per ride: " + fare/rides.size());
            } else if (choice == 3) {
                break;
            }
        }
